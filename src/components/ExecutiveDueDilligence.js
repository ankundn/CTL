...
<p className="lead text-center text-muted pt-2 mb-5"> We conduct due
         ...
         companies or partners.</p>
         <p className="lead text-center text-muted pt-2 mb-5">Our executive due diligence investigations may
     be tailored to cover the following areas:</p>
<section>
...
<div className="col-md-6 col-lg-5 col-xl-4">
      ...
      <p className="text-muted mb-5 pb-md-3">Explanation on Links to Organized Crime</p>
    </div> 
    <div className="col-md-6 col-lg-5 col-xl-4">
      <h5 className="font-weight-normal border-top border-primary pt-4 mb-4">Verification of Credentials</h5>
      <p className="text-muted mb-5 pb-md-3">Explanation on Verification of Credentials</p>
    </div> 

<div className="w-100"></div>
<div className="col-md-6 col-lg-5 col-xl-4">
      <h5 className="font-weight-normal border-top border-primary pt-4 mb-4">Debts and Solvency</h5>
      <p className="text-muted mb-5 pb-md-3">Explanation on Debts and Solvency</p>
    </div> 
    <div className="col-md-6 col-lg-5 col-xl-4">
      <h5 className="font-weight-normal border-top border-primary pt-4 mb-4">Judgements</h5>
...
export default ExecutiveDueDilligence;
